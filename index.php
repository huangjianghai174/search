...
<html lang="zh-CN">
 <head> 
  ...
  <link rel="stylesheet" href="//at.alicdn.com/t/font_3006233_99rzovp6pm6.css" />
 ...
 <body> 
  ...
  <div class="list closed"> 
   <ul>
    ...
    <li><a rel="nofollow" href="http://192.168.123.90:6080/" target="_blank"><i class="iconfont icon-daohang-" style="color: #2196f3;"></i>内网导航</a></li>
    ...
    <li><a rel="nofollow" href="https://mail.fiberhome.com/" target="_blank"><i class="iconfont icon-logo_fiberhome-colour" style="color: #f05;"></i></a></li>
    <!----> 
    

    <li class="title"><i class="iconfont icon-yumingyuwangzhan"></i> 我的网站</li> 
    <li><a rel="nofollow" href="https://nas.hjhai.cn/" target="_blank"><i class="iconfont icon-NASshebei" style="color:#e48;"></i>NAS</a></li> 
    <li><a rel="nofollow" href="https://wiz.hjhai.cn/" target="_blank"><i class="iconfont icon-biji" style="color:#e02;"></i>Wiz</a></li> 
    <li><a rel="nofollow" href="https://wiki.hjhai.cn/dokuwiki/doku.php?id=start&do=index" target="_blank"><i class="iconfont icon-wikiicon" style="color:#56f;"></i>Wiki</a></li>  
    <li><a rel="nofollow" href="https://zfile.hjhai.cn/" target="_blank"><i class="iconfont icon-yunpan"></i>Z-file</a></li> 
    <li><a rel="nofollow" href="https://mm.hjhai.cn/#/" target="_blank"><i class="iconfont icon-tianchongxing-" style="color:#f06;"></i>Bitwarden</a></li> 
    <li><a rel="nofollow" href="https://hjhai.cn/" target="_blank"><i class="iconfont icon-blog"></i>BLOG</a></li> 
    
    
    <!----> 
    <li class="title"><i class="iconfont icon-kongzhitai"></i> 开发</li> 
    <li><a rel="nofollow" href="https://www.runoob.com/" target="_blank"><i class="iconfont icon-runoob1" style="color: #f03;"></i>菜鸟</a></li> 
    ...
    <li><a rel="nofollow" href="https://www.csdn.net/" target="_blank"><i class="iconfont icon-CN_csdnnet" style="color: #f03;"></i>CSDN</a></li> 
    ...
    <li><a rel="nofollow" href="https://www.huya.com/" target="_blank"><i class="iconfont icon-huya" style="color:#1d0;"></i>虎牙</a></li> 
